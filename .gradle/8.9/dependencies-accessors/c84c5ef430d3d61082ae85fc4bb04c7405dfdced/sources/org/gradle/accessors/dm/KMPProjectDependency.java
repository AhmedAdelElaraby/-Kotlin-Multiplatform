...
@NonNullApi
public class KMPProjectDependency extends DelegatingProjectDependency {

    @Inject
    public KMPProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
